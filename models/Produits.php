<?php
class Produits
{ // contenu les différents methodes nécessaires à la conn et à la l'interrogation l'écriture dans ma base de donn
    // Connexion
    private $connexion;
     ...
     * @return void
     */
    // requete sql qui va me permette d'aller chercher la liste de mais produits 
    public function lire()
    {
        ...
        return $query; //resultat est returné sans passer par l'etape fetch, le fetch à l'interieur de fichier api(lire.php)
    }
